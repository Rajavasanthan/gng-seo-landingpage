            ...
            <div className="flex flex-col items-center justify-between md:flex-row">
                ...
                <div className="md:w-[700px] w-full">
                    <Slider ref={sliderRef} {...settings} autoplay arrows={false}>
                        ...
                        <FeedBackCard name="Chutti Aravind" designation="Entertainer" description="I highly recommend Grids and Guides as a best Web designing Company in Chennai that is competent, talented and professional. Grids and Guides successfully took on my point of view of my project. By staying engaged, asking questions, and giving suggestions, my vision became his vision. This was important as the project was to transfer to my website an excel management system that I used for years to manage my runners. His straightforward programming not only produced an exact replica, but created a more efficient, intuitive, and complete management system that has cut my admin time so dramatically I can now handle 5 clients in the time it previously took me to handle 1 client."/>
                        <FeedBackCard name="Gopinath" designation="GoImpex and Traders" description="When it comes to creating professional, attractive, and effective websites, there is no company that can surpass Web Design Enterprise. Thanks to their talent, our site has taken off in the search engines like a rocket. In this day and age, it is impossible to get ahead as a business without the support of gurus like Web Design Enterprise standing behind you."/>
                    </Slider>
                </div>
            </div>
        </div>
