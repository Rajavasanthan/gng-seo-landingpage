    ...
    return (
        <div id="homepage">
            <div className="bg-[#F7F8FD] md:h-[580px]">
                <div className="grid grid-cols-1 mx-auto max-w-7xl md:grid-cols-2">
                    <div className="p-4 m-auto sm:p-2 md:p-0">
                        ...
                        <p className="text-[#A5A5A5] text-[16px] sm:text-[20px] sm:px-2 md:p-0  mt-2">Our skilled Developers possess expertise with some of the most robust, scalable, secure backend frameworks to develop the best Angular app remotely and reliably.</p>
                        <Link
                            to="contactpage"
                            spy={true}
                            smooth={true}
            ...
            <div className="grid grid-cols-1 sm:gap-10 mx-auto space-y-3 md:space-y-0 md:grid-cols-4 max-w-7xl mt-0 md:mt-[-100px]">
                <HeroSectionOneCard image={"/assets/minilogo4.svg"} count={8} text={"Years Experinece"} />
