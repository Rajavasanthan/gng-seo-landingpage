...
export default function ClientCard() {
    ...
    return (
        <div className="bg-[#3D4C61] text-white px-[45px] md:px[100px] py-[30px] sm:py-[80px] overflow-x-hidden relative">
            ...
            <img src="/assets/orange-white-logo.png" alt="squares" className="mr-4 h-8" />
            Our Clients
            </p>
    </div>
            ...
            <div className="relative my-10">
                ...
                <Slider ref={sliderRef} {...settings} autoplay arrows={false}>
                    ...
                    <SliderComponent image={"/assets/workmate.svg"} name={"workmate"} />
                    <SliderComponent image={"/assets/pulllogic.svg"} name={"pulllogic"} />
                    <SliderComponent image={"/assets/cratoflow.svg"} name={"cratoflow"} />
                    <SliderComponent image={"/assets/blacksheep.svg"} name={"blacksheep"} />
                    <SliderComponent image={"/assets/workmate.svg"} name={"workmate"} />
                    <SliderComponent image={"/assets/pulllogic.svg"} name={"pulllogic"} />
                    <SliderComponent image={"/assets/cratoflow.svg"} name={"cratoflow"} />
