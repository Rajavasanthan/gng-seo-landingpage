        ...
        <div>
            <div className="mx-auto sm:my-10 max-w-7xl mb-3 md:mb-[-100px]">
                <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
                    <HeroSectionFourCard image={"/assets/research-consultant.svg"} text={"Dedicated Resource Consulting"} description={"Our team of research consultants are dedicated to turning potential ideas into impactful projects. We help companies in all stages of research process with our multi industry expertise."} />
                    <HeroSectionFourCard image={"/assets/img3.svg"} text={"App Development"} description={"Our app developers build mobile and web apps from scratch or re-engineer an existing app to your expectations. Our team is highly skilled, experienced and known for sticking to the project deadlines."} />
